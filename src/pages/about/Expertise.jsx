  ...
  return (
    ...
    //   data-aos="fade-down" 
      className="px-5 sm:px-[72px] mt-32 relative">
          <div className='flex '>
              <div className='w-1/2'>
                  <div className='bg-main relative py-20 pl-20 h-full'>
                      <img src={IMAGES.Expertise} alt="" className='w-full absolute' />
                  </div>
              </div>

              <div className='w-1/2 p-12 ml-20 flex flex-col justify-center'>
