    ...
    <section className="relative padding padding_top">
      ...
      <div  className="grid grid-cols-1 min-[900px]:grid-cols-3 gap-6">
        <div data-aos="fade-down" className=" border-2 border-secondary text-center">
          <img src={IMAGES.WhatWeDo1} alt="" className="w-full" />
          <div className="mt-6 mb-9 mx-4 min-[1100px]:mx-9">
            <h4 className="mb-3 font-bold text-xl sm:text-2xl ">
              {t("common.whatwedo.box1title")}
            </h4>
            <p className="sm:text-lg text-base">
              {t("common.whatwedo.box1paragraph")}
            </p>
          </div>
        </div>

        <div data-aos="fade-down" className=" border-2 border-secondary text-center">
          <img src={IMAGES.WhatWeDo2} alt="" className=" w-full" />
          <div className="mt-6 mb-9 mx-4 min-[1100px]:mx-9">
            <h4 className="mb-3 font-bold text-xl sm:text-2xl">
              {t("common.whatwedo.box2title")}
            </h4>
            <p className="text-base sm:text-lg">
              {t("common.whatwedo.box2paragraph")}
            </p>
          </div>
        </div>

        <div data-aos="fade-down"  className=" border-2 border-secondary text-center">
          <img src={IMAGES.WhatWeDo3} alt="" className="w-full" />
          <div className="mt-6 mb-9 mx-4 min-[1100px]:mx-9">
            <h4 className="mb-3 font-bold text-xl sm:text-2xl">
              {t("common.whatwedo.box3title")}
            </h4>
            <p className="text-base sm:text-lg">
              {t("common.whatwedo.box3paragraph")}
            </p>
          </div>
        </div>
      </div>
